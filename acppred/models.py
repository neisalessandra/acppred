...
class Model:
    ...
    def __init__(self, estimator, positive_peptides, negative_peptides):
        ...
        Args:
            - estimator: a skt-learn estimator
    ...
    def transform(self, X):
        """
        Transform a set of protein sequences to amino acid percentage
    ...
    def predict(self, sequence):
        """
        Predicts the anticancer activity of a given peptide

        Args:
            - sequence: peptide sequence for analysis
        """
